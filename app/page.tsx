    ...
    <main className="min-h-screen bg-[#fff8e7] text-[#29251f]">
      <header className="sticky top-0 z-30 border-b border-black/10 bg-[#d71920] text-white shadow-sm">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 md:px-6">
          <div>
            <h1 className="text-2xl font-black tracking-normal md:text-3xl">100 Sono Delivery</h1>
            <p className="text-xs font-semibold text-yellow-100 md:text-sm">Lanches, pizzas e combos no capricho</p>
          </div>
      ...
      <section className="bg-[#d71920]">
        <div className="mx-auto grid max-w-7xl gap-6 px-4 py-6 md:grid-cols-[1fr_0.95fr] md:items-center md:px-6 md:py-10">
          <div className="max-w-2xl text-white">
            <p className="mb-3 inline-flex rounded-full bg-[#ffc72c] px-4 py-2 text-sm font-black text-[#29251f]">
              Delivery aberto hoje
            </p>
            <h2 className="text-4xl font-black leading-tight md:text-6xl">
              Seu combo chega quente e sem enrolação.
            </h2>
            <p className="mt-4 max-w-xl text-base font-medium text-red-50 md:text-lg">
          ...
          <div className="relative min-h-[230px] overflow-hidden rounded-md bg-[#ffc72c] shadow-2xl md:min-h-[360px]">
            <img
              ...
              className="h-full min-h-[230px] w-full object-cover md:min-h-[360px]"
            />
            <div className="absolute bottom-4 left-4 rounded-md bg-white px-4 py-3 shadow-lg">
              ...
              <p className="text-lg font-black">Combo Turbo</p>
            </div>
          </div>
        </div>
      </section>
